...
command_t think(agent_info_t info)
{
	...
	if (brains[info.bee].hasflower == true)
	{
		...
		if (find_neighbour(info, FLOWER) >= 0)
			obstacle = 1;
		else if (find_neighbour(info, OUTSIDE) >= 0)
			obstacle = 1;
		else if (find_neighbour(info, FLOWER) >= 0)
			obstacle = 1;
		else if (find_neighbour(info, OUTSIDE) >= 0)
			obstacle = 1;
		else if (find_neighbour(info, BEE_0) >= 0)
			obstacle = 1;
		else if (find_neighbour(info, BEE_0_WITH_FLOWER) >= 0)
			obstacle = 1;
		else if (find_neighbour(info, BEE_1) >= 0)
			obstacle = 1;
		else if (find_neighbour(info, BEE_1_WITH_FLOWER) >= 0)
			obstacle = 1;
		else if (find_neighbour(info, WALL) >= 0)
			obstacle = 1;
		if (obstacle >= 0)
		{
			return (command_t) {
